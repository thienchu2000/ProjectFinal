...
function showPendingModallll() {
  document.getElementById("botpay").style.display = "block";
}

function hidePendingModallll() {
  document.getElementById("botpay").style.display = "none";
}
